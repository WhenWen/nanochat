...
parser.add_argument("--fixed-yoco", action="store_true", help="reuse the midpoint residual as K/V input in the upper half of layers")
...
def build_model_meta(depth):
    ...
    config = GPTConfig(
        ...
        window_pattern=args.window_pattern, fixed_yoco=args.fixed_yoco,
    )
